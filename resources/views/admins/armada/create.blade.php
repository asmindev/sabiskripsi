...
@section('title', 'Tambah Armada - Sistem Manajemen Truk Sampah')
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex items-center justify-between h-16">
                <div class="flex items-center space-x-4">
                    ...
                    <div>
                        <h1 class="text-xl font-bold text-gray-900">Tambah Armada Baru</h1>
                        <p class="text-sm text-gray-500">Isi form untuk menambah armada truk sampah</p>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
                    ...
                    <div class="bg-white rounded-xl shadow-lg p-6">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <div>
                                ...
                                <input type="text" name="namaTruk" value="{{ old('namaTruk') }}"
                            ...
                            <div>
                                <label class="block text-sm font-medium text-gray-700 mb-1">Nomor Plat <span
                                        class="text-red-500">*</span></label>
                                <input type="text" name="nomorPlat" value="{{ old('nomorPlat') }}"
                            ...
                            <div>
                                ...
                                <input type="date" name="lastMaintenance" value="{{ old('lastMaintenance') }}"
                                    class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500">
                            </div>
                        </div>
                    </div>
                ...
                <div class="lg:col-span-1">
                    <div class="bg-white rounded-xl shadow-lg p-6 sticky top-8">
                        <h3 class="text-lg font-semibold text-gray-900 mb-2">Pilih TPS</h3>
                        <p class="text-xs text-gray-500 mb-4">Pilih TPS yang akan di-assign ke armada ini (Hanya TPS
                            yang belum ter-assign)</p>
                            ...
                            <div class="space-y-2">
                                ...
                                <div class="flex items-start p-2 hover:bg-gray-100 rounded">
                                    <input type="checkbox" name="tps_ids[]" id="tps_{{ $tps->id }}"
                                        ...
                                        onchange="updateSelectedCount()" {{ in_array($tps->id, old('tps_ids', [])) ?
                                    'checked' : '' }}>
                                ...
                                <div class="text-center py-8 text-gray-500">
                                    ...
                                    <p class="text-sm">Semua TPS sudah ter-assign</p>
                                </div>
                                @endforelse
                            </div>
                        </div>
                        ...
                        <div class="mt-3 text-sm text-gray-600">
                            ...
                            <span id="selectedCount">0</span> TPS dipilih
                        </div>
