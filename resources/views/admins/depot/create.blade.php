...
@section('title', 'Tambah Depot - Sistem Manajemen Truk Sampah')
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex items-center justify-between h-16">
                <div class="flex items-center space-x-4">
                    ...
                    <div>
                        <h1 class="text-xl font-bold text-gray-900">Tambah Depot</h1>
                        <p class="text-sm text-gray-500">Tambah lokasi depot baru</p>
                    </div>
                </div>
                <div class="flex items-center space-x-4">
    ...
    <div class="w-full px-4 sm:px-6 lg:px-8 py-8">
        <div class="bg-white rounded-xl shadow-lg p-6">
            <div class="flex gap-4 flex-col lg:flex-row">
                ...
                <form action="{{ route('depot.store') }}" method="POST" class="space-y-6 w-1/3">
                    @csrf
                    ...
                    <div>
                        ...
                        <select name="type" required
                            ...
                            <option value="endpoint">Tempat Pembuangan Akhir</option>
                            <option value="startpoint">Depot</option>
                        </select>
                    </div>
                    ...
                    <div>
                        ...
                        <textarea name="alamat" rows="3" required
                            class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-indigo-500"
                            placeholder="Masukkan alamat lengkap depot"></textarea>
                    </div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div>
                            ...
                            <input type="number" name="latitude" step="any" required id="latitude"
                                class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-indigo-500"
                                placeholder="Contoh: -5.147665">
                        </div>
                        <div>
                            <label class="block text-sm font-medium text-gray-700 mb-2">Koordinat Longitude</label>
                            <input type="number" name="longitude" step="any" required id="longitude"
                                class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-indigo-500"
